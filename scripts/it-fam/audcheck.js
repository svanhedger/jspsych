...
*/
	...
	var volume_check_1 = {
      ...
      stimulus: "<p>Welcome to the study. You will first complete a short volume calibration and headphone check.</p><p>" +
	  "Please make sure you are in a quiet listening environment, that you are wearing heaphones, and that your computer's volume is turned on.<p></p>",
	  choices: ['Continue'],
	  post_trial_gap: 250
    };
...
// procedure that randomly presents the six trials and provides feedback to Participants
	...
	var welcome = {
		type: "html-button-response",
		stimulus: "<p>The volume calibration and headphone check are now complete.</p>",
		choices: ['Continue']
	};
