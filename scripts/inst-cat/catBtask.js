...
var prac_instruct = {
  ...
  stimulus: '<p>You will now have the opportunity to practice the categorization task.</p>'+
            ...
            '<p><input class="jspsych-btn" style="background-color:#FADBD8;" id="MIN" type="button" value="Minor" onclick="playMin1()"><audio id="playerMin1" src="examples/B000.wav"></audio></input><input class="jspsych-btn" style="background-color:#D1F2EB;" id="MAJ" type="button" value="Major" onclick="playMaj1()"><audio id="playerMaj1" src="examples/B100.wav"></audio></input></p>'+
...
var explicit_var = [
  {audio: 'sounds/vibraphone/vB000.wav', instrument: 'vibraphone', instrument_type: 'happy'},
  {audio: 'sounds/xylophone/xB000.wav', instrument: 'xylophone', instrument_type: 'happy'},
  {audio: 'sounds/marimba/mB000.wav', instrument: 'marimba', instrument_type: 'happy'},
  {audio: 'sounds/piano/pB000.wav', instrument: 'piano', instrument_type: 'neutral'},
  {audio: 'sounds/flute/fB000.wav', instrument: 'flute', instrument_type: 'sad'},
  {audio: 'sounds/violin/vB000.wav', instrument: 'violin', instrument_type: 'sad'},
  {audio: 'sounds/oboe/oB000.wav', instrument: 'oboe', instrument_type: 'sad'}
];
