var jsPsychInstructions = (function (jspsych) {
  ...
  class InstructionsPlugin {
      ...
      trial(display_element, trial) {
          ...
          const after_response = (info) => {
              ...
              keyboard_listener = this.jsPsych.pluginAPI.getKeyboardResponse({
                  ...
                  valid_responses: [trial.key_forward[0], trial.key_forward[1], trial.key_backward],
              ...
              for (var i = 0; i<trial.key_forward.length;i++){
              if (this.jsPsych.pluginAPI.compareKeys(info.key, trial.key_forward[i])) {
                  next();
              }}
          };
          show_current_page();
      ...
      simulate_visual(trial, simulation_options, load_callback) {
          ...
          const advance = (rt) => {
              if (trial.allow_keys) {
                  this.jsPsych.pluginAPI.pressKey(trial.key_forward[0], rt);
              }
