...
var shorten = 7; //for shorten test trails
...
var train_11 = {
	...
	stimulus: '<div style="font-family: arial; size: 16px;"><p>The practice is now over. You will now begin the real experiment. </p>'+
				'<p>There will be two parts to this task. Each part consists of 5 videos of moving dots, similar to what you just saw.</br>In the first part, you must track 2 targets just as you did in the practice. Remember to submit your result by pressing the <b>ENTER key</b>.'+
...
var MOTVARS_TWO_01 = MOTVARS_TWO.slice(0,shorten);
...
var MOTVARS_THREE_01 = MOTVARS_THREE.slice(0,shorten);
...
var MOT_RESP_MAIN_TWO = {
	...
	prompt: '<div class="wrapper"><p style="font-size:12px; color: 	#E0FFFF;"><strong>Type your answer in the ANSWER BOX. Do not put spaces between numbers. Order does not matter.</strong><input class="mot" id="mot" type="text" placeholder="ANSWER BOX" onkeydown="search(this)" onkeypress="return isNumber(event)" maxlength="2"></input>(Press ENTER to submit your answer)</p>',
	choices: ['Enter'],
	on_finish: function(data){
		var ansArray = curMOT_RESP.split('');
		ansArray = ansArray.sort(); //sorted answer (from 1-8)
...
var MOT_RESP_MAIN_THREE = {
	type: 'image-keyboard-response',
	stimulus: jsPsych.timelineVariable('resp_img'),
	stimulus_height: stimHeight,
	data: {designation: jsPsych.timelineVariable('type'), correct: jsPsych.timelineVariable('corANS')},
	prompt: '<div class="wrapper"><p style="font-size:12px; color: 	#E0FFFF;"><strong>Type your answer in the ANSWER BOX. Do not put spaces between numbers. Order does not matter.</strong><input class="mot" id="mot" type="text" placeholder="ANSWER BOX" onkeydown="search(this)" onkeypress="return isNumber(event)" maxlength="3"></input>(Press ENTER to submit your answer)</p>',
	choices: ['Enter'],
	on_finish: function(data){
		var ansArray = curMOT_RESP.split('');
		ansArray = ansArray.sort(); //sorted answer (from 1-8)
...
var MOT2_PROC = {
	timeline: [MOT_VID_MAIN, MOT_RESP_MAIN_TWO],
	timeline_variables: MOTVARS_TWO_01
};


var MOT3_PROC = {
	timeline: [MOT_VID_MAIN, MOT_RESP_MAIN_THREE],
